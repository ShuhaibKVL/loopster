...
export default function UnlikeHandleButton({postId,refetchPosts}:{postId:string,refetchPosts: () => Promise<void> | (() => Promise<QueryObserverResult<InfiniteData<{ posts: unknown; hasMore: boolean }>, Error>> );}) {
