...
export default function LikeHandleButton({postId,refetchPosts}:{postId:string,refetchPosts: () => Promise<QueryObserverResult<InfiniteData<{ posts: any; hasMore: boolean }>, Error>>;}) {
